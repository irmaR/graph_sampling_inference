    ...
    for i in range(4):
        ...
        # Or you can keep using add_subplot, which may be simpler:
          ...
          if i==0 or i==2 or i==4:
            ax.set_ylabel('Avg_RelEr',size=30)
          

        #ax.set_yscale('log')
        ax.set_title("pattern size: "+str(level), fontsize=30)
        ...
        if i==0:
          ax.legend(['FK-OBD', 'FK-AD'],loc = 'upper right', bbox_to_anchor = (0,0.5,1.02,0.5),prop={'size':20})
...
if __name__=='__main__':
  ...
  main_multiple_pattern_size_plots([5,6,7,8,9,10],'/home/irma/work/RESULTS/graph_sampling/facebook_csvs/','facebook',10,2,2,eligibility=False)
