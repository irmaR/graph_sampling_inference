    ...
    for i in xrange(0,m):
        for j in xrange(0,n):
            ...
            for level in pattern_sizes:
                 ...
                 average_relative_errors_furer_AD_10=get_average_errors_per_percentage(map_furer_AD_10_to_percentages_rel_errors,step_percentage)   
                 ...
                 stdev_furer_AD_10=get_stdev_per_percentage(map_furer_AD_to_percentages_rel_errors,step_percentage)
            ...
            avg_ERR_AD_10=get_average_errors_per_percentage(all_average_relative_errors_furer_AD_10,step_percentage)
            ...
            ax.plot(x,avg_ERR_AD_10,color='green',linewidth=3.0)
            ...
            ax.errorbar(x, avg_ERR_AD_10,yerr=stdev_furer_AD, fmt='o',color='green',linewidth=2.0)
            ax.set_ylim([0,1])
            #ax.set_yscale('log')
            axis_counter+=1
    plt.legend(['FK-OBD', 'FK-AD','FK-AD-10'],loc = 'upper right', bbox_to_anchor = (0,0.5,1.0,0.5),prop={'size':16})
...
def main_multiple_pattern_size_plots_one_plot(pattern_sizes,path_to_csv,exp,step_percentage,eligibility=True):
    ...
    pattern_counter=0
    level=0
    plt.ylabel('AvgRelError',size=20)
...
if __name__=='__main__':
  ...
  main_multiple_pattern_size_plots([4,5,6,7,8,9,10],args.r,['y','imdb','facebook','webkb'],['/home/irma/workspace/DMKD_Paper_Sampling/yeast_csvs/','/home/irma/workspace/DMKD_Paper_Sampling/imdb_csvs/','/home/irma/workspace/DMKD_Paper_Sampling/facebook_csvs/','/home/irma/workspace/DMKD_Paper_Sampling/webkb_csvs/'],10,2,2,eligibility=False)
