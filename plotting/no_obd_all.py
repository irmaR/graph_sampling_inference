...
amazon_path='/home/irma/workspace/DMKD_Paper_Sampling/amazon_csvs/'
enronr_path='/home/irma/workspace/DMKD_Paper_Sampling/enron_csvs'
facebook_path='/home/irma/workspace/DMKD_Paper_Sampling/facebook_csvs/'
dblp_path='/home/irma/workspace/DMKD_Paper_Sampling/dblp_csvs/'
yeast_path='/home/irma/workspace/DMKD_Paper_Sampling/yeast_csvs/'
webkb_path='/home/irma/workspace/DMKD_Paper_Sampling/webkb_csvs/'
imdb_path='/home/irma/workspace/DMKD_Paper_Sampling/imdb_csvs/'

pattern_sizes=[4,5,6,7,8,9,10];
paths=[amazon_path,enronr_path,dblp_path]
#paths=[facebook_path,yeast_path,imdb_path]
...
eligible_patterns={}
nr_eligible_patterns=0
step_percentage=10
nr_eligible=0
nr_no_obd=0
nr_obd=0
for path_to_csv in paths:
    for level in pattern_sizes:
          if 'amazon' in path_to_csv or 'enron' in path_to_csv or 'dblp' in path_to_csv:
              version=2
              exp=2
          else:
              version=1
...
print 'Nr eligible',nr_eligible
print 'Nr no obd',nr_no_obd
print 'Nr obd',nr_obd
...
print stdev_furer_OBD
print stdev_furer_AD
