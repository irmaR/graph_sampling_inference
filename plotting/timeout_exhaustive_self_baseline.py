...
def main_multiple_pattern_size_plots(pattern_sizes,path_to_csv,exp,step_percentage):
       ...
       plt.errorbar(x, average_relative_errors_furer_OBD, color='red',yerr=stdev_furer_OBD,linewidth=3.5,elinewidth=2)
       plt.errorbar(x, average_relative_errors_furer_AD, color='blue',yerr=stdev_furer_AD,linewidth=3.5,elinewidth=2)
       plt.errorbar(x, average_relative_errors_random, color='green',yerr=stdev_random,linewidth=3.5,elinewidth=2)
       #plt.errorbar(x, average_relative_errors_exh, color='m',yerr=stdev_furer_AD,linewidth=3.5,elinewidth=2)
       #for cap in caps:
       #    print cap
       #    cap.set_markeredgewidth(2)
       #plt.legend(['FK-OBD', 'FK-AD','Random','Exhaustive'],loc = 'upper right',prop={'size':30})
       plt.legend(['FK-OBD', 'FK-AD','Random'],loc = 'upper right',prop={'size':30})
