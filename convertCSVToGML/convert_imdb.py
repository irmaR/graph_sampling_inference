...
#for g in worked_under:
#    print g,worked_under[g]
...
print "Nr nodes: ",len(D.nodes())

#for d in D.nodes():
#    if D.node[d]['predicate']=="actsIn":
#        print "Node: ",D.node[d]
#        ne=D.neighbors(d)
#        print "Nr neighb: ",len(ne)
#        for n in ne:
#            print "Neighb:",D.node[n]

nx.write_gpickle(D,FILE_NAME)
#vis.visualize_graph_standard(D)
#nx.write_gml(D,FILE_NAME)
